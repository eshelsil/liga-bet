...
@section('content')
    <div class="all-ltr" style="margin-bottom: 30px;">
        ...
        <div class="text-part">
            ...
            <p>סכומי הזכייה עלולים להשתנות בהתאם לכמות המשתתפים, אך השאיפה היא לחלוקה הנ"ל:</p>
            <ul style="margin-top: 8px;">
                <li><u>מקום ראשון:</u> 60% מהקופה</li>
                <li><u>מקום שני:</u> 30% מהקופה</li>
                <li><u>מקום שלישי:</u> 10% מהקופה</li>
                <li><u>מקום רביעי:</u> זוכה בדמי הכניסה (150 ש"ח)</li>
            </ul>
            <p>* ההחלטה הסופית תתקבל ברגע שיוודע כמה משתתפים בטורניר זה</p>
        </div>
