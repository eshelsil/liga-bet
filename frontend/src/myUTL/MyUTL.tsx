import { Table, tableCellClasses, TableBody, TableCell, TableRow, IconButton, TextField, Link } from '@mui/material';
				...
				>
					<TableBody>
						...
						<TableRow>
							...
							<TableCell>{UtlRoleToString[currentUtl.role]}</TableCell>
						</TableRow>
						<TableRow>
							<TableCell className="property">שם טורניר</TableCell>
							<TableCell>{currentUtl.tournament.name}</TableCell>
						</TableRow>
						{tableData && (<>
							<TableRow>
								<TableCell className="property">מיקום בטבלה</TableCell>
								<TableCell>{tableData.rank}</TableCell>
							</TableRow>
							<TableRow>
								<TableCell className="property">נקודות</TableCell>
						...
						<TableRow>
							...
							<TableCell>
								<Link onClick={goToMyBets} style={{cursor: 'pointer'}}>
									צפייה בהיומרים
								</Link>
							</TableCell>
						</TableRow>
