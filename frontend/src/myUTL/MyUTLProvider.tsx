...
import {
	updateMyUTLAndStore
} from '../_actions/tournamentUser';
import { CurrentTournamentUser, NoSelector, MyUtlOnScoreboard } from '../_selectors';
...
function MyUTLProvider({updateMyUTLAndStore}){
	...
	const updateMyUTL = (params: PayloadUpdateMyUTL) => updateMyUTLAndStore(currentUtl.tournament.id, params);
