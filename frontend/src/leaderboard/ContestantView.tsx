...
export function ContestantView({
    rankDisplay,
    scoreboardRow: { rank, change, id, name, addedScore, score },
    matchBets,
    groupStandingsBets,
    questionBets,
}: Props) {
    ...
    const prizesCount = 4
    const prizeClass =
        rank <= prizesCount ? `prize_rank prize_rank_${rank}` : ''

    return (
        <div
            className="LigaBet-Contestant panel-group"
            style={{ marginBottom: 0 }}
        >
            <div className="panel panel-default">
                <div
                    className={`panel-heading row ${prizeClass}`}
                    ...
                    >
                        <h4 className="panel-title">
                            <a
                                ...
                                href={`#collapserank-${id}`}
                            >
                                <span className="admin">{id}</span>
                                {name}
                            </a>
                        </h4>
                    </div>
                ...
                >
                    ...
                    >
                        <li className="active" style={{ float: 'right' }}>
                            <a data-toggle="tab" href={`#groups-${id}`}>
                                משחקים
                            </a>
                        </li>
                        <li style={{ float: 'right' }}>
                            <a data-toggle="tab" href={`#group-ranks-${id}`}>
                                מיקומי בתים
                            </a>
                        </li>
                        <li style={{ float: 'right' }}>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="col-xs-3 pull-right col-no-padding">
                                        סוג
                                    </div>
