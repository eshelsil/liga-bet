            ...
            <InitialDataFetcher>
                <Switch>
                    ...
                    <Route
                        ...
                        component={GroupStandingsBetsView}
                    />
                    <Route
                        path="/all-questions"
                        component={AllQuestionBetsView}
                    />
