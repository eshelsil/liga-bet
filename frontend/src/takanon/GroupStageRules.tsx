            ...
            <tbody>
                <tr>
                    <td rowSpan={4} className="groupRank v-align-center">
                        <div>1. <TeamAndSymbol {...teamA}/></div>
                        <div>2. <TeamAndSymbol {...teamB}/></div>
                        <div>3. <TeamAndSymbol {...teamC}/></div>
                        <div>4. <TeamAndSymbol {...teamD}/></div>
                    </td>
                ...
                <tr>
                    <td className="groupRank">
                        <div>1. <TeamAndSymbol {...teamA}/></div>
                        <div>2. <TeamAndSymbol {...teamC}/></div>
                        <div>3. <TeamAndSymbol {...teamB}/></div>
                        <div>4. <TeamAndSymbol {...teamD}/></div>
                    </td>
                    <td>{minorMistake}</td>
                    <td></td>
                ...
                <tr>
                    <td className="groupRank">
                        <div>1. <TeamAndSymbol {...teamC}/></div>
                        <div>2. <TeamAndSymbol {...teamA}/></div>
                        <div>3. <TeamAndSymbol {...teamB}/></div>
                        <div>4. <TeamAndSymbol {...teamD}/></div>
                    </td>
                    <td>0</td>
